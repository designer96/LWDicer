...
namespace LWDicer.UI
{
    public partial class FormManualOP : Form
    {
        ...
        private void btnMarkRegisterA_Click(object sender, EventArgs e)
        {
            ...
            if (iCamNo == FINE_CAM)
                CMainFrame.LWDicer.m_DataManager.ModelData.MicroPatternA = CMainFrame.LWDicer.m_Vision.GetSearchData(iCamNo, PATTERN_A);
        ...
        private void btnMarkRegisterB_Click(object sender, EventArgs e)
        {
            ...
            if (iCamNo == FINE_CAM)
                CMainFrame.LWDicer.m_DataManager.ModelData.MicroPatternB = CMainFrame.LWDicer.m_Vision.GetSearchData(iCamNo, PATTERN_B);
